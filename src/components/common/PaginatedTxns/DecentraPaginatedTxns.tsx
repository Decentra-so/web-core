...
import TxListChat from '@/components/transactions/TxList/TxListChat'
...
const TxPage = ({
  ...
  return (
    <>
      ...
      {page && page.results.length > 0 && <TxListChat items={page.results} />}
...
const DecentraPaginatedTxns = ({ useTxns }: { useTxns: typeof useTxHistory | typeof useTxQueue }): ReactElement => {
...
export default DecentraPaginatedTxns
