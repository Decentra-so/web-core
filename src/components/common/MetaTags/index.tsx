...
const descriptionText =
  'Decentra is building on top of Safe (prev. Gnosis Safe) which is the most trusted platform to manage digital assets on Ethereum and multiple EVMs. Over $60B secured.'
