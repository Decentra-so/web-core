...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://app.safe.global/images/social-new-share.png" />
    ...
    <meta name="twitter:image" content="https://app.safe.global/images/social-new-share.png" />
